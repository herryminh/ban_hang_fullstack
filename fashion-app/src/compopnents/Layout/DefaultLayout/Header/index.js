                    ...
                    <div className={cx('item', 'product-dropdown')}>
                        ...
                        {openProduct && (
                            <div className={cx('product-menu-popup')}>
                                <Button to="/category/clothes" onClick={() => setOpenProduct(false)}>
                                    Quần áo
                                </Button>
                                <Button to="/category/bags" onClick={() => setOpenProduct(false)}>
                                    Túi xách
                                </Button>
                                <Button to="/category/shoes" onClick={() => setOpenProduct(false)}>
                                    Giày dép
                                </Button>
                            </div>
                        )}
